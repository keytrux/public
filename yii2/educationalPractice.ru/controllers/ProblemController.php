...
class ProblemController extends Controller
{
    ...
    public function actionSolve($id)
    {
        ...
        if ($model->load($this->request->post())) 
        {
            ...
            // $newFileName = md5($model->photo_after->baseName.'.'.$model->photo_after->extension.time()).'.' .
            // $model->photo_after->extension;
            // $model->photo_after->saveAs('@app/web/uploads/' . $newFileName);
            // $model->photo_after = $newFileName;
