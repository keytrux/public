...
function makeHttpRequest(string $method, string $url, string $bearerToken, $open_image_in_binary = null,  $body = null) {
...
class JsonApi {
    ...
    function api(string $method, $entity, $filter = "", $open_image_in_binary = null, $body = null) {
        return makeHttpRequest($method, cfg()->moyskladJsonApiEndpointUrl . $entity . $filter, $this->accessToken, $open_image_in_binary, $body);
    }
